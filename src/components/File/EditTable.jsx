...
export default function EditTable() {
    ...
    useEffect(() => {
        ...
        results.forEach(transaction => {
            let foundCategory = userCategories.find(category => category._id === transaction.data.category_id)
            if (foundCategory){
                if ((foundCategory.name === 'UNIDENTIFIED') || (foundCategory.name === '')){
                    let expenseObj = {
                        ...transaction.data,
